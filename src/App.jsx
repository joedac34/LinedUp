 ...
 *{box-sizing:border-box;margin:0;padding:0;-webkit-tap-highlight-color:transparent;}
 ...
 {!isFirst && (
 <button onClick={()=>setTutorialStep(s=>s-1)} style={{flex:1,background:"rgba(255,255,255,0.08)",border:"none",borderRadius:14,padding:"13px",fontSize:15,fontWeight:700,color:"rgba(255,255,255,0.7)",cursor:"pointer",fontFamily:"Barlow,sans-serif"}}>Back</button>
 )}
 <button onClick={()=>isLast?dismissTutorial():setTutorialStep(s=>s+1)} style={{flex:2,background:IOS.blue,border:"none",borderRadius:14,padding:"13px",fontSize:15,fontWeight:700,color:"#fff",cursor:"pointer",fontFamily:"Barlow,sans-serif"}}>{isLast?"Let's Go! ":"Next"}</button>
 </div>
 </div>
 </div>
 );
 ...
 <div style={{fontSize:10,fontWeight:700,marginTop:1,letterSpacing:0.3,color:isTied?IOS.blue:isWinning?IOS.green:IOS.red}}>
