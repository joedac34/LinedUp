...
export default function App() {
  ...
  const css=`
    ...
    *{box-sizing:border-box;margin:0;padding:0;-webkit-tap-highlight-color:transparent;}
    ...
    .phone{width:390px;min-height:844px;background:#000;position:relative;overflow:hidden;display:flex;flex-direction:column;font-family:Optima,'Segoe UI',system-ui,-apple-system,sans-serif;color:#fff;-webkit-font-smoothing:antialiased;padding-top:env(safe-area-inset-top,0px);box-sizing:border-box;}
    ...
    /* iOS Primary Button */
    .ios-btn{width:calc(100% - 32px);margin:4px 16px;border:none;border-radius:14px;padding:16px;font-family:Optima,'Segoe UI',sans-serif;font-size:17px;font-weight:600;cursor:pointer;transition:opacity .15s,transform .1s;letter-spacing:-0.2px;display:flex;align-items:center;justify-content:center;gap:8px;}
    ...
    .sheet-search{width:100%;background:rgba(255,255,255,0.08);border:none;border-radius:10px;padding:9px 14px 9px 40px;font-family:Optima,'Segoe UI',sans-serif;font-size:15px;color:#fff;outline:none;}
    ...
    .ticker-item{display:inline-flex;align-items:center;gap:7px;padding:0 22px;font-size:13px;font-weight:600;color:rgba(255,255,255,0.5);letter-spacing:0.02em;font-family:Optima,'Segoe UI',sans-serif;}
    ...
    .pu-use-btn{background:${IOS.fill2};border:none;border-radius:8px;padding:7px 14px;font-family:Optima,'Segoe UI',sans-serif;font-size:13px;font-weight:600;color:${IOS.blue};cursor:pointer;white-space:nowrap;flex-shrink:0;}
    ...
    .spin-ios-btn{background:${IOS.blue};color:#fff;border:none;border-radius:14px;padding:16px 48px;font-family:Optima,'Segoe UI',sans-serif;font-size:17px;font-weight:600;cursor:pointer;letter-spacing:-0.3px;transition:opacity .15s;}
    ...
    .chat-field{flex:1;background:${IOS.bg3};border:none;border-radius:20px;padding:10px 16px;font-family:Optima,'Segoe UI',sans-serif;font-size:15px;color:#fff;outline:none;letter-spacing:-0.2px;}
  ...
  return (
    <div style={{minHeight:"100vh",background:"#111",display:"flex",justifyContent:"center",alignItems:"flex-start"}}>
          ...
          <div style={{position:"fixed",inset:0,zIndex:9000,pointerEvents:"all"}}>
            ...
            <div style={{
              ...
              <div style={{display:"flex",gap:10}}>
                {!isFirst && (
                  <button onClick={()=>setTutorialStep(s=>s-1)} style={{flex:1,background:"rgba(255,255,255,0.08)",border:"none",borderRadius:14,padding:"13px",fontSize:15,fontWeight:700,color:"rgba(255,255,255,0.7)",cursor:"pointer",fontFamily:"Optima,'Segoe UI',sans-serif"}}>Back</button>
                )}
                <button onClick={()=>isLast?dismissTutorial():setTutorialStep(s=>s+1)} style={{flex:2,background:IOS.blue,border:"none",borderRadius:14,padding:"13px",fontSize:15,fontWeight:700,color:"#fff",cursor:"pointer",fontFamily:"Optima,'Segoe UI',sans-serif"}}>{isLast?"Let's Go! 🏆":"Next"}</button>
              </div>
            </div>
          </div>
        );
      ...
      {/* ══ AUTH SCREEN ══ */}
      {!user && (
        <div style={{width:390,minHeight:"100vh",background:"#09090f",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"40px 32px",fontFamily:"Optima,'Segoe UI',sans-serif"}}>
          ...
          <input id="auth-email" type="email" placeholder="Email" style={{width:"100%",background:"#1C1C1E",border:"1px solid rgba(255,255,255,0.1)",borderRadius:12,padding:"14px 16px",color:"#fff",fontSize:15,fontFamily:"Optima,'Segoe UI',sans-serif",outline:"none",marginBottom:12}}/>
          <input id="auth-password" type="password" placeholder="Password" style={{width:"100%",background:"#1C1C1E",border:"1px solid rgba(255,255,255,0.1)",borderRadius:12,padding:"14px 16px",color:"#fff",fontSize:15,fontFamily:"Optima,'Segoe UI',sans-serif",outline:"none",marginBottom:12}}/>
          {authScreen==="signup"&&<input id="auth-username" type="text" placeholder="Username (e.g. sharpshooter99)" style={{width:"100%",background:"#1C1C1E",border:"1px solid rgba(255,255,255,0.1)",borderRadius:12,padding:"14px 16px",color:"#fff",fontSize:15,fontFamily:"Optima,'Segoe UI',sans-serif",outline:"none",marginBottom:8}}/>}
          ...
          }} style={{width:"100%",background:"#0A84FF",color:"#fff",border:"none",borderRadius:12,padding:"16px",fontSize:16,fontWeight:700,cursor:"pointer",fontFamily:"Optima,'Segoe UI',sans-serif",marginBottom:16}}>
          ...
          <div className="pu-modal-bg" onClick={()=>setShowPUModal(null)}>
            <div className="pu-modal-sheet" onClick={e=>e.stopPropagation()}>
              ...
              <div style={{padding:"14px 20px 0"}}>
                <button onClick={()=>setShowPUModal(null)} style={{width:"100%",background:IOS.bg3,border:"none",borderRadius:12,padding:"14px",fontFamily:"Optima,'Segoe UI',sans-serif",fontSize:15,fontWeight:600,color:IOS.label2,cursor:"pointer"}}>Cancel</button>
              </div>
            </div>
          </div>
        )}
          ...
          <div style={{
            ...
            <style>{`
              ...
              .spin-glow-btn{
                ...
                font-family: Optima,'Segoe UI',sans-serif; font-size: 18px; font-weight: 800;
          ...
          <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",zIndex:1000,display:"flex",alignItems:"center",justifyContent:"center",padding:24}}>
            <div style={{background:IOS.bg2,borderRadius:24,padding:28,width:"100%",maxWidth:340,boxShadow:"0 20px 60px rgba(0,0,0,0.5)"}}>
              ...
              <input
                ...
                autoFocus
                style={{width:"100%",background:"#1C1C1E",border:`1.5px solid ${usernamePromptError?IOS.red:IOS.blue}`,borderRadius:12,padding:"12px 14px",color:"#fff",fontSize:16,fontFamily:"Optima,'Segoe UI',sans-serif",outline:"none",marginBottom:8,boxSizing:"border-box"}}
              />
              ...
              }} style={{width:"100%",background:usernamePromptSaving?"rgba(255,255,255,0.1)":IOS.blue,border:"none",borderRadius:12,padding:"14px",fontSize:16,fontWeight:700,color:usernamePromptSaving?"rgba(255,255,255,0.3)":"#fff",cursor:usernamePromptSaving?"default":"pointer",fontFamily:"Optima,'Segoe UI',sans-serif",marginBottom:10}}>
                      ...
                      <div style={{marginTop:8,background:"rgba(10,132,255,0.1)",borderRadius:14,padding:"14px 20px",border:`1px solid ${IOS.blue}30`,width:"100%",maxWidth:280}}>
                        ...
                        <div style={{display:"flex",gap:8}}>
                          <button onClick={()=>shareInvite(activeLeague.invite_code||activeLeague.inviteCode, activeLeague.name)}
                            style={{flex:1,background:IOS.blue,border:"none",borderRadius:10,padding:"10px",fontFamily:"Optima,'Segoe UI',sans-serif",fontSize:13,fontWeight:700,color:"#fff",cursor:"pointer"}}>
                            📤 Share
                          </button>
                          <button onClick={async()=>{const c=activeLeague.invite_code||activeLeague.inviteCode;try{await navigator.clipboard.writeText(c);alert("Copied! ✓");}catch(e){alert(c);}}}
                            style={{flex:1,background:"rgba(255,255,255,0.08)",border:"1px solid rgba(255,255,255,0.12)",borderRadius:10,padding:"10px",fontFamily:"Optima,'Segoe UI',sans-serif",fontSize:13,fontWeight:700,color:"#fff",cursor:"pointer"}}>
                            📋 Copy
                          </button>
                        </div>
                      </div>
                    ...
                    {(()=>{
                      ...
                      const renderCard = (picks, isMe, expandId) => {
                        if(!picks || picks.length===0) return (
                          <div style={{flex:1,borderRadius:10,minHeight:80,background:"#0A0A0A",border:"0.5px dashed #1E1E1E",display:"flex",alignItems:"center",justifyContent:"center"}}>
                        ...
                        const border = won?"#30D158":lost?"#FF3B30":isMe?"#1A3A5A":"#1E1E1E";
                        ...
                        const ptsBg = won?"rgba(48,209,88,0.1)":lost?"rgba(255,59,48,0.1)":"#1A1A1A";
                        const ptsColor = won?IOS.green:lost?IOS.red:"#444";
                        const ptsLabel = won?`+${pts}pts`:lost?"+0pts":"pending";

                        return (
                          <div style={{flex:1,borderRadius:10,padding:"8px 9px",minHeight:80,background:bg,border:`0.5px solid ${border}`,display:"flex",flexDirection:"column",justifyContent:"space-between",cursor:isParlay?"pointer":undefined}}
                            ...
                            {isParlay&&<div style={{fontSize:8,color:IOS.blue,marginTop:3}}>▾ tap to see legs</div>}
                            {isParlay&&(
                    ...
                    {newLeagueCreated ? (
                      <div style={{padding:"24px 24px 8px",textAlign:"center"}}>
                        ...
                        <div style={{background:IOS.bg3,borderRadius:16,padding:"20px 24px",marginBottom:20,border:`1px solid ${IOS.blue}30`}}>
                          ...
                          <div style={{display:"flex",gap:10,marginTop:16}}>
                            <button onClick={()=>shareInvite(newLeagueCreated.invite_code, newLeagueCreated.name)}
                              style={{flex:1,background:IOS.blue,border:"none",borderRadius:12,padding:"12px",fontFamily:"Optima,'Segoe UI',sans-serif",fontSize:14,fontWeight:700,color:"#fff",cursor:"pointer"}}>
                              📤 Share Invite
                            </button>
                            <button onClick={async()=>{try{await navigator.clipboard.writeText(newLeagueCreated.invite_code);alert("Copied! ✓");}catch(e){alert(newLeagueCreated.invite_code);}}}
                              style={{flex:1,background:"rgba(255,255,255,0.08)",border:"1px solid rgba(255,255,255,0.15)",borderRadius:12,padding:"12px",fontFamily:"Optima,'Segoe UI',sans-serif",fontSize:14,fontWeight:700,color:"#fff",cursor:"pointer"}}>
                              📋 Copy Code
                            </button>
                          </div>
                        ...
                        <button onClick={()=>{
                          ...
                          setNewLeagueName("");
                          setNewLeagueSize(8);
                        }} style={{width:"100%",background:IOS.blue,border:"none",borderRadius:14,padding:"16px",fontFamily:"Optima,'Segoe UI',sans-serif",fontSize:17,fontWeight:600,color:"#fff",cursor:"pointer"}}>
                          Go to My League →
                        </button>
                      </div>
                    ) : (
                      <div style={{padding:"20px 20px 0"}}>
                        ...
                        <input
                          ...
                          style={{width:"100%",background:"rgba(255,255,255,0.07)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:12,padding:"14px 16px",color:"#fff",fontSize:16,fontFamily:"Optima,'Segoe UI',sans-serif",outline:"none",marginBottom:24,boxSizing:"border-box"}}
                        />
                        ...
                        <button
                          ...
                          style={{width:"100%",background:newLeagueSport&&newLeagueName.trim()?IOS.blue:"rgba(255,255,255,0.1)",border:"none",borderRadius:14,padding:"16px",fontFamily:"Optima,'Segoe UI',sans-serif",fontSize:17,fontWeight:600,color:newLeagueSport&&newLeagueName.trim()?"#fff":"rgba(255,255,255,0.3)",cursor:newLeagueSport&&newLeagueName.trim()?"pointer":"default",transition:"all .2s"}}
                        >
              ...
              {leaguesLoading ? (
                ...
                <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"48px 32px",textAlign:"center",gap:12}}>
                  ...
                  <button onClick={()=>{setShowNewLeague(true);setNewLeagueCreated(null);setNewLeagueSport(null);setNewLeagueName("");setNewLeagueSize(8);}}
                    style={{marginTop:8,background:IOS.blue,border:"none",borderRadius:14,padding:"14px 32px",fontFamily:"Optima,'Segoe UI',sans-serif",fontSize:16,fontWeight:700,color:"#fff",cursor:"pointer"}}>
                    + Create a League
                  </button>
                  ...
                  {weekPicks.length>0&&(()=>{
                    ...
                    return (
                        ...
                        {pendingCount>0&&(
                          <div style={{padding:"10px 14px",borderTop:`0.5px solid ${IOS.sep}`,display:"flex",gap:8}}>
                            <button onClick={async()=>{
                              ...
                              fetchStandings(activeLeagueId);
                            }} style={{flex:1,background:"rgba(255,69,58,0.1)",border:"1px solid rgba(255,69,58,0.2)",borderRadius:8,padding:"8px",fontFamily:"Optima,'Segoe UI',sans-serif",fontSize:12,fontWeight:700,color:IOS.red,cursor:"pointer"}}>
                      ...
                      <div style={{padding:"10px 14px",borderTop:`0.5px solid ${IOS.sep}`}}>
                        ...
                        }} style={{width:"100%",background:"linear-gradient(135deg,"+IOS.blue+","+IOS.indigo+")",border:"none",borderRadius:10,padding:"12px",fontFamily:"Optima,'Segoe UI',sans-serif",fontSize:14,fontWeight:700,color:"#fff",cursor:"pointer",letterSpacing:-0.2}}>
                ...
                <>
                  ...
                  <div style={{margin:"0 16px 12px",background:IOS.bg2,borderRadius:16,overflow:"hidden",border:"1px solid rgba(255,255,255,0.07)"}}>
                    ...
                    <div style={{padding:"14px 16px"}}>
                      ...
                      }} style={{width:"100%",background:"rgba(10,132,255,0.15)",border:"1px solid rgba(10,132,255,0.3)",borderRadius:12,padding:"12px",fontFamily:"Optima,'Segoe UI',sans-serif",fontSize:14,fontWeight:700,color:IOS.blue,cursor:"pointer",marginBottom:10}}>
                        ⚡ Run Auto-Grade Now
                      </button>
                      <button onClick={async()=>{
                      ...
                      }} style={{width:"100%",background:advancingWeek?"rgba(255,255,255,0.08)":IOS.green,border:"none",borderRadius:12,padding:"14px",fontFamily:"Optima,'Segoe UI',sans-serif",fontSize:15,fontWeight:700,color:advancingWeek?"rgba(255,255,255,0.3)":"#000",cursor:advancingWeek?"default":"pointer"}}>
          ...
          <>
            <div className="body">
                  ...
                  {editingUsername ? (
                    <div style={{display:"flex",flexDirection:"column",gap:6}}>
                      <input
                        ...
                        autoFocus
                        style={{background:"#2C2C2E",border:`1px solid ${usernameError?IOS.red:IOS.blue}`,borderRadius:10,padding:"8px 12px",color:"#fff",fontSize:15,fontFamily:"Optima,'Segoe UI',sans-serif",outline:"none",width:180}}
                      />
                    ...
                    return (
                      ...
                      <div style={{padding:"14px 20px 10px",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                        ...
                        {displaySpins > 0 && isActiveLeague
                          ? <button onClick={()=>setShowWheel(true)} style={{background:`linear-gradient(135deg,${IOS.indigo},${IOS.purple})`,border:"none",borderRadius:10,padding:"8px 16px",fontFamily:"Optima,'Segoe UI',sans-serif",fontSize:13,fontWeight:600,color:"#fff",cursor:"pointer",display:"flex",alignItems:"center",gap:8}}>
                              🎰 Spin Wheel
                              <span style={{background:"rgba(255,255,255,0.25)",borderRadius:20,padding:"1px 8px",fontSize:12,fontWeight:800}}>{displaySpins}</span>
                            </button>
                          : <button disabled style={{background:"rgba(255,255,255,0.07)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:10,padding:"8px 16px",fontFamily:"Optima,'Segoe UI',sans-serif",fontSize:13,fontWeight:600,color:"rgba(255,255,255,0.25)",cursor:"not-allowed",display:"flex",alignItems:"center",gap:8}}>
                              🎰 Spin Wheel
              ...
              <div style={{padding:"0 16px 4px"}}>
                <button onClick={()=>setTutorialStep(0)} style={{width:"100%",background:"rgba(255,255,255,0.06)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:12,padding:"14px",fontSize:15,fontWeight:600,color:"rgba(255,255,255,0.7)",cursor:"pointer",fontFamily:"Optima,'Segoe UI',sans-serif"}}>
                  ❓ How to Play
                </button>
              </div>
              ...
              <div style={{padding:"8px 16px 32px",display:"flex",flexDirection:"column",gap:10}}>
                <button onClick={async()=>{
                  ...
                  setFlexPicks(EMPTY_FLEX);
                  setScreen("home");
                }} style={{width:"100%",background:"rgba(255,59,48,0.1)",border:"1px solid rgba(255,59,48,0.2)",borderRadius:12,padding:"14px",fontSize:15,fontWeight:600,color:IOS.red,cursor:"pointer",fontFamily:"Optima,'Segoe UI',sans-serif"}}>
                  Sign Out
                </button>
                <button onClick={async()=>{
                ...
                }} style={{width:"100%",background:"transparent",border:"none",borderRadius:12,padding:"10px",fontSize:13,fontWeight:600,color:"rgba(255,59,48,0.5)",cursor:"pointer",fontFamily:"Optima,'Segoe UI',sans-serif"}}>
                  Delete Account
                </button>
              </div>
          ...
          <div style={{position:"fixed",inset:0,zIndex:9500,display:"flex",alignItems:"flex-end",justifyContent:"center",padding:"0"}} onClick={()=>setWeekResult(null)}>
            ...
            <div onClick={e=>e.stopPropagation()} style={{position:"relative",background:"#111",borderRadius:"28px 28px 0 0",width:"100%",maxWidth:480,maxHeight:"90vh",overflowY:"auto",WebkitOverflowScrolling:"touch",paddingBottom:40}}>
              ...
              <div style={{padding:"16px 16px 0",display:"flex",gap:10}}>
                <button onClick={()=>setWeekResult(null)} style={{flex:1,background:weekResult.won?"rgba(48,209,88,0.15)":"rgba(255,69,58,0.15)",border:`1px solid ${weekResult.won?"rgba(48,209,88,0.3)":"rgba(255,69,58,0.3)"}`,borderRadius:14,padding:"14px",fontSize:15,fontWeight:700,color:weekResult.won?IOS.green:IOS.red,cursor:"pointer",fontFamily:"Optima,'Segoe UI',sans-serif"}}>
